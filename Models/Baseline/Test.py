...
test_input_dir = r"/NAC_Dataset_Test/Test_NAC"
test_output_dir = r"/NAC_Dataset_Test/Test_Att"
...
test_loader = DataLoader(test_dataset, batch_size=1, shuffle=True,num_workers=workers)
